/*
 * $Id: monitube-data_logging.h 346460 2009-11-14 05:06:47Z ssiano $
 *
...
/**
 * @file monitube-data_logging.h
 * @brief Relating to logging
 * 
 * These functions / macros are for logging in this component
 */
 
#ifndef __MONITUBE_DATA_LOGGING_H__
#define __MONITUBE_DATA_LOGGING_H__
...
#define LOG(_level, _fmt...)   \
    logging((_level), "MONITUBE-DATA: " _fmt)

/**
 * Define an INSIST/assert with logging
 */
#define INSIST_ERR(c) if (!(c)) \
    logging(LOG_EMERG, "MONITUBE-DATA: %s:%d: insist '%s' failed!", \
