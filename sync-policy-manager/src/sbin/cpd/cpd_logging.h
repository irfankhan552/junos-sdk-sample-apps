/*
 * $Id: cpd_logging.h 346460 2009-11-14 05:06:47Z ssiano $
 *
...
#ifndef __CPD_LOGGING_H__
#define __CPD_LOGGING_H__
...
#define LOG(_level, _fmt...)   \
    logging((_level), "CPD: " _fmt)

/**
 * Define an INSIST/assert with logging
 */
#define INSIST_ERR(c) if (!(c)) \
    logging(LOG_EMERG, "CPD: %s:%d: insist '%s' failed!", \
